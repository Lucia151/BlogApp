...
function EditPost() {
  ...
  return (
      ...
      <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
        ...
        <div className="flex flex-col">
          <div className="flex items-center space-x-4 md:space-x-8">
            <input value={cat} onChange={(e)=>setCat(e.target.value)}className="px-4 py-2 outline-none border-2" placeholder="Update a post category" type="text"/>
    ...
    {/* Each category has it's own div */}
        ...
        <textarea rows={15} cols={30} className="px-4 py-2 border-4" placeholder="Enter post description"/>
        <button className="bg-black w-full md:w-[40%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg rounded-md">Update</button>
      </form>
