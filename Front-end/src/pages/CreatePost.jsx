  ...
  return (
    <div>
          ...
          <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
            ...
            <div className="flex flex-col">
              <div className="flex items-center space-x-4 md:space-x-8">
                <input value={cat} onChange={(e)=>setCat(e.target.value)}className="px-4 py-2  border-2" placeholder="Enter post category" type="text"/>
        ...
        {/* Each category has it's own div */}
            ...
            <button className="bg-black w-full md:w-[20% mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg rounded-lg">Post</button>
          </form>
